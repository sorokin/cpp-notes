...
В данном примере функция g() выводит <<derived>>, а функция f() выводит <<base>>, поскольку внутри catch объект исключения был скопирован и новая копия имеет тип base.
