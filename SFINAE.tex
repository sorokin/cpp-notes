...
\subsection{Различные способы использования SFINAE}
	...
	До сих пор в данной статье рассматривалось только использование SFINAE с помощью изменения типа возвращаемого значения функции (например, с \mintinline{c++}{bool} на \mintinline{c++}{enable_if<some_condition, bool>::type}).
