...
% TODO: может быть сделать этот раздел как вывод в общем случае
% обходим ParamType и decltype(expr) и спускаемся по типам?
...
int main()
{
	f(0, NULL);
				...
				% TODO: написать, что сквозь него выводить невозможно
				% TODO: дальше его можно абузить
