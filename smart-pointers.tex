...
Также уместно представить сравнение производительностей разных видов указателей. На приведенных графиках по оси OY отмечено среднее время соответствующей операции (в тактах процессора Intel Core i5-5257U @ 2.70GHz). Также отмечена дисперсия для каждого из измерений.
