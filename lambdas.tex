...
Поскольку \mintinline{c++}{std::function}~--- один тип для всех функцинальных объектов с заданной сигнаурой,
...
\end{minted}
Этот пример демонстрирует, что лямбды можно использовать с variadic templates, а также возвращение лямбд из функций.
